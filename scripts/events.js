import {
  ...
  export default function ({ controls, timer, sound }) {
    ...
    marioVolume.addEventListener('change', function () {
      sound.mario.volume = this.value
    })
    
    digimonVolume.addEventListener('change', function () {
      sound.digimon.volume = this.value
    })
